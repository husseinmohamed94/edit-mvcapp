...
<div class="wrapper">
    ...
    <div class="employees">
        <a href="/mvcapp/public/index.php/employee/add"><?= $tex_add_employee ?></a>
        <table class="data">
            <thead>
            <tr>
                <th>ID</th>
                ...
                foreach ($employees as $employee){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/mvcapp/public/index.php/employee/delete/<?= $employee->id ?>" onclick="if(!confirm('<?= $text-delete_confirm ?> ')) return false ; " >delete </a>
                        </td>
                    </tr>
                    <?php
